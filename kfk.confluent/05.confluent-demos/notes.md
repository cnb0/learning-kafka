...
# Confluent Demos
    ...
    [kafak Admin REST API Demo](https://github.com/confluentinc/demo-scene/tree/master/adminrest)
    [kafak KSQL Demo](https://github.com/confluentinc/demo-scene/blob/master/ksql-workshop/ksql-workshop.adoc)
...
- [SelfBalancing Clusters](https://docs.confluent.io/platform/current/kafka/sbc/sbc-tutorial.html)
